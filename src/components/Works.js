        ...
        >
          <div className="container font-display mx-auto pt-[5rem]">
            <div className="flex flex-col justify-center items-center ">
              <span className="uppercase text-4xl font-bold pb-4">
                my works
              </span>
              ...
              <div className="max-w-6xl mx-auto px-5 py-24 ">
                <div className="flex flex-wrap -m-4">
                  <div className="xl:w-1/3 md:w-1/2 p-4 w-96">
                    <div className="border border-yellow-300 p-6 rounded-lg shadow-[0px_0px_25px_-9px_rgba(0,0,0,0.3)]">
                      <div className="w-10 h-10 flex rounded-full  text-indigo-500 mb-4">
                        <img alt="icons" src={nextjs} className="mr-2" />
                        <img alt="icons" src={prisma} className="mr-2" />
                        <img alt="icons" src={graphql} className="mr-1 px-1" />
                      </div>
                      <h2 className="text-2xl font-bold title-font pt-2">
                        Alef
                      </h2>
                      <h4 className="font-thin text-gray-500 pb-5">
                        Web application
                      </h4>
                      <p className="leading-relaxed text-base">
                        <a
                          href="https://www.alefvr.com/"
                          className="text-white bg-brand px-3 py-2 rounded"
                        >
                          <button>view</button>
                        </a>
                      </p>
                  ...
                  <div className="xl:w-1/3 md:w-1/2 p-4 w-96">
                    <div className="border border-yellow-300 p-6 rounded-lg shadow-[0px_0px_25px_-9px_rgba(0,0,0,0.3)]">
                      <div className="w-10 h-10 flex rounded-full  text-indigo-500 mb-4">
                        <img alt="icons" src={nextjs} className="" />
                        <img alt="icons" src={aws} className="px-2" />
                      </div>
                      <h2 className="text-2xl font-bold title-font pt-2">
                        Fleet management
                      </h2>
                      ...
                      <p className="leading-relaxed text-base">
                        <a
                          href="https://main.dx3l5bsdsih29.amplifyapp.com/"
                          className="text-white bg-brand px-3 py-2 rounded"
                        >
                          <button>view</button>
                        </a>
                  ...
                  <div className="xl:w-1/3 md:w-1/2 p-4 w-96">
                    <div className="border border-yellow-300 p-6 rounded-lg shadow-[0px_0px_25px_-9px_rgba(0,0,0,0.3)]">
                      ...
                      <p className="leading-relaxed text-base">
                        <a
                          href="https://digelab.herokuapp.com/"
                          className="text-white bg-brand px-3 py-2 rounded"
                        >
                          <button>view</button>
                        </a>
                  ...
                  <div className="xl:w-1/3 md:w-1/2 p-4 w-96">
                    <div className="border border-yellow-300 p-6 rounded-lg shadow-[0px_0px_25px_-9px_rgba(0,0,0,0.3)]">
                      ...
                      <h2 className="text-2xl font-bold title-font pt-2 pb-10">
                        other works
                      </h2>
