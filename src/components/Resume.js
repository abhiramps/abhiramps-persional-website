      ...
      <div className="font-display mx-auto  pt-[5rem] container">
        ...
        <ScrollAnimation animateIn="fadeIn">
          <Tabs className="container react-tabs grid grid-cols-12 justify-around sm:px-0 sm:justify-around">
            <TabList
              className="col-span-12 md:col-span-4 w-[100%] shadow-[0px_5px_5px_-3px_rgba(0,0,0,0.3)]  sm:w-auto min-w-[20%] 
            ...
            <TabPanel className={tabPannelStyle()}>
              <ScrollAnimation animateIn="fadeIn">
                      ...
                      <li className="text-brand">
                        <div className="flex justify-between flex-row p-1 md:my-4">
                          <div className="pb-3">
                            ...
                            <p
                              className="text-gray-600 uppercase text-xs font-extralight mt-1 
                          ...
                          <label
                            className="self-start py-1 text-md px-4 mb-2
                    ...
                    {Skills.map((item) => (
                      <li className="text-brand col-span-12  sm:col-span-6 md:col-span-6 lg:py-2">
                        <div className="flex justify-between sm:justify-around  md:justify-between">
                          <span className="lg:text-xl md:font-bold capitalize flex-none">
                            {item.skills}
                          </span>
...
const tabPannelStyle = () => {
  return "container col-span-12 md:col-span-8 react-tabs__tab-panel mt-10 ml-2 md:ml-5 md:mt-0";
};
